"""
detector.py – Vision-Modul für Figuren- und Handerkennung
"""
...
class Detector:
    def __init__(self, model_path=None):
        self.model = None  # später: YOLO / TensorFlow-Modell laden
    ...
    def detect(self, frame) -> List[Detection]:
        """Dummy-Erkennung: erkennt große bewegte Bereiche als 'hand'."""
