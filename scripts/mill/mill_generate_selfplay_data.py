...
from gaming_robot_arm.config import (  # noqa: E402
    MILL_ENABLE_FLYING,
...
from gaming_robot_arm.games.mill.neural_features import (  # noqa: E402
...
def _move_key(move) -> tuple[str, str, str]:
    return (move.src or "", move.dst, move.capture or "")


def _target_index_or_raise(legal_moves, chosen_move) -> int:
    try:
    ...
    with args.output.open("w", encoding="utf-8") as fp:
        for game_index in range(1, args.games + 1):
            ...
            while len(session.move_history) < args.max_plies and not session.is_terminal():
                ...
                target_index = _target_index_or_raise(legal_moves, chosen_move)
