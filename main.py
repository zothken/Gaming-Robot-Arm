...
def build_parser(argv: Sequence[str] | None = None) -> argparse.ArgumentParser:
    ...
    # Muehle-CLI-Argumente nur bei Bedarf laden, damit UI/Vision ohne ML-Importe starten.
    if _requested_mode(argv) == "play-mill":
        from gaming_robot_arm.games.mill.playable import add_mill_cli_arguments
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.mode == "play-mill":
        from gaming_robot_arm.games.mill.playable import run_mill_game
